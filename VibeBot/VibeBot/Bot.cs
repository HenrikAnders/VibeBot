...
namespace VibeBot
{
    class Bot
    {
        ...
        private string path1;    //to break stackoverflow from property
        public string path { private get
            {
                return this.path1;
            }
            set
        ...
        /// <summary>
        /// for moving the converted file into the bin
        /// </summary>
        /// <param name="element">path to file</param>
